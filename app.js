...
// joe.scope shows the object that was previously written.
// 2. What is "this" when joe.scopeArrow() is invoked?
//scopeArrow shows the whole window and everything that is displayed 
// 3. Explain why "this" is different when an arrow function is used.
//using the this in an arrow function makes the value global so it displays everything because it cannot pull in the information from the object of Student.